...
// This ONLY handles the initial load if a user arrives via a direct link 
// (e.g. from an email: yoursite.com/documentation/shift#mosaics)
onMounted(() => {
  if (route.hash) {
    nextTick(() => {
      setTimeout(() => {
...
// Function to handle smooth scrolling for in-page text links
const scrollToSection = (sectionId) => {
  const element = document.getElementById(sectionId);
  if (element) {
    const headerOffset = 100; // Matches your layout offset
    const elementPosition = element.getBoundingClientRect().top;
    const offsetPosition = elementPosition + window.scrollY - headerOffset;
    ...
    // Updates the URL hash cleanly without a jump
...
<template>
  <div class="doc-inner-page">
        ...
        <section id="overview">
          <h2>4.1. Overview of approach</h2>
          <p>
            The velocity fields are derived using <a href="#algorithms" @click.prevent="scrollToSection('algorithms')">intensity tracking algorithms</a> applied to consecutive 
          ...
          <ul>
			...
			<a href="#algorithms" @click.prevent="scrollToSection('algorithms')">standard methods</a>.</li>
			...
			<li><strong>Mosaic creation:</strong> The 'raw' velocity fields derived from Sentinel-1 swaths are geocoded to a common grid then further corrections 
          ...
          <p>
			...
			<div class="info-box">
			  ...
			  <p>
				...
				ground topography. As part of our processing, we also produce ground-projected radar amplitude images (as shown in Fig. 4.2).
			  </p>
			</div>
		...
		<section id="algorithms">
          <h2>4.4. Measurement Algorithms</h2>
          <p>
		  ...
		  <h3>4.4.1. Interrogation Areas (IAs)</h3>
		  <p>
		  ...
		  <h3>4.4.2. Frequency Domain Cross-Correlation</h3>
		  <p>
		  ...
		  <h3>4.4.3. Sub-Pixel Peak Finding</h3>
		  <p>
		  ...
		  <h3>4.4.4. Advanced Refinements</h3>
		  <p>
		...
		<section id="post-processing">
          <h2>4.5. Post-processing</h2>
			  ...
			  <h3>4.5.1. Stage 1: Segmentation Filtering (Radar Geometry)</h3>
			  <p>
			  ...
			  <h3>4.5.2. Stage 2: Ionospheric Destriping</h3>
			  <p>
			  ...
			  <h3>4.5.3. Stage 3: Map Projection & Outlier Removal</h3>
			  <p>
		...
		<section id="mosaics">
          <h2>4.6. Mosaics</h2>
			  ...
			  <h4>Step 1. Velocity Magnitude Outlier Detection</h4>
			  <p>
			  ...
			  <h4>Step 2. Velocity Gradient Filter (Texture Consistency)</h4>
			  <p>
			  ...
			  <h4>Step 3. Flow Direction Stability</h4>
			  <p>
