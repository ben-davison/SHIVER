...
if current_os == "Windows":
    ...
    stanage_gr_grio1_path = Path("/mnt/grio1/Shared/SHIVER/data/Greenland/date_pair.zarr")
    stanage_ant_grio1_path = Path("/mnt/grio1/Shared/SHIVER/data/Antarctica/date_pair.zarr")
