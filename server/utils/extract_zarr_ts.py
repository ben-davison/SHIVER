...
if current_os == "Windows":
    ...
    stanage_gr_grio1_path = Path("/home/sa_gg1bjd/web_HPC/data/Greenland/mini_date_pair.zarr")
    stanage_ant_grio1_path = Path("/home/sa_gg1bjd/web_HPC/data/Antarctica/mini_date_pair.zarr")
